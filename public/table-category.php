...
?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Категории</a></li>
        </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-category.php"><button type="button" class="btn bg-blue waves-effect">ДОБАВИТЬ КАТЕГОРИЮ</button></a>
                            </div>
                        </div>
                        ...
                        <div class="body table-responsive">
							...
							<div class="col-sm-10">По вашему запросу ничего не найдено.</div>
