 ...
 ?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Администратор</a></li>
        </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-member.php"><button type="button" class="btn bg-blue waves-effect">ДОБАВИТЬ АДМИНИСТРАТОРА</button></a>
                            </div>
                        </div>
                            ...
                            <form method="get">
                                <div class="col-sm-10">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="keyword" placeholder="поиск пользователя...">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
