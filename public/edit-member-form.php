...
?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="members.php">Администратор</a></li>
            <li class="active">Редактирование администратора</a></li>
        </ol>
                                ...
                                <div>
                                    ...
                                    <div class="form-group form-float col-sm-12">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label">Ещё раз пароль</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                         <button class="btn bg-blue waves-effect pull-right" type="submit" name="btnEdit">ПРИМЕНИТЬ</button>
                                    </div>
