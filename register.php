<?php
	...
	$sql = "INSERT INTO tbl_fcm_token (user_android_token, app_version, os_version, device_model, device_manufacturer) VALUES ('$token', '$app_version', '$os_version', '$device_model', '$device_manufacturer')";
