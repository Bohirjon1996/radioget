...
?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="settings.php">Настройки</a></li>
            <li class="active">Поменять API Key</a></li>
        </ol>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="header">
                                <h2>ПОМЕНЯТЬ API KEY</h2>
                                <div class="header-dropdown m-r--5">
                                    <button type="submit" name="submit" class="btn bg-blue waves-effect" onclick="return confirm('Are you sure want to update API Key?')">Обновить API Key</button>
                                </div>
                                <br>
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-2">
                                        <a class="btn bg-blue waves-effect" href="change-api-key.php?generate=true">Сгенерировать</a>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <div class="font-12">Поменять API Key</div>
